...
(function() {
  ...
  var e = {
    ...
    defaultAxis: {
      labels: { enabled: !0 },
      ticks: { stroke: "#cfd8dc" },
      minorTicks: { stroke: "#eceff1" }
    },
    defaultGridSettings: { stroke: "#cfd8dc" },
    defaultMinorGridSettings: { stroke: "#eceff1" },
    defaultSeparator: { fill: "#eceff1" },
    defaultLegend: {
      position: "right",
      vAlign: "middle",
      align: "left",
      ...
      paginator: { orientation: "bottom", fontSize: 14 },
      title: { padding: { bottom: 10 }, hAlign: "left", fontSize: 16 }
    },
    defaultTooltip: {
      title: { fontColor: "#263238", padding: { bottom: 8 }, fontSize: 18 },
      separator: { enabled: !1, padding: { bottom: 8 } },
      background: { fill: "#F9FAFB 0.95", stroke: "#eceff1", corners: 2 },
      padding: { top: 10, right: 20, bottom: 15, left: 20 },
      fontColor: "#78909c"
    },
    defaultColorRange: {
      stroke: "#bdc8ce",
      ticks: { stroke: "#bdc8ce", position: "outside", length: 7, enabled: !0 },
      minorTicks: {
        stroke: "#bdc8ce",
        position: "outside",
        length: 5,
    ...
    chart: {
      defaultSeriesSettings: {
        ...
        ohlc: {
          normal: { risingStroke: "#0288d1", fallingStroke: "#f8bbd0" },
          hovered: { risingStroke: b, fallingStroke: b },
          selected: { risingStroke: "3 #0288d1", fallingStroke: "3 #f8bbd0" }
        }
      },
      title: {
        fontSize: 20,
    ...
    financial: { yAxes: [{}] },
    map: {
      unboundRegions: { enabled: !0, fill: "#e8ecf1", stroke: "#bdc8ce" },
      defaultSeriesSettings: {
        base: {
          normal: { stroke: "#eceff1", labels: { fontColor: "#212121" } }
        },
        bubble: { normal: { stroke: b } },
        connector: {
          normal: {
            stroke: "#0288d1",
            markers: { fill: "#58abd7", stroke: "1.5 #e8ecf1" }
          },
          hovered: { stroke: "#58abd7", markers: { stroke: "1.5 #e8ecf1" } },
          selected: {
            stroke: "1.5 #000",
            markers: { fill: "#000", stroke: "1.5 #e8ecf1" }
          }
        }
      }
    },
    sparkline: {
      ...
      defaultSeriesSettings: {
        area: { stroke: "1.5 #0288d1", fill: "#0288d1 0.5" },
        column: { fill: "#0288d1", negativeFill: "#f8bbd0" },
        line: { stroke: "1.5 #0288d1" },
        winLoss: { fill: "#0288d1", negativeFill: "#f8bbd0" }
      }
    },
    bullet: {
      background: { stroke: "#ffffff" },
      defaultMarkerSettings: { fill: "#0288d1", stroke: "2 #0288d1" }
    },
    treeMap: {
      normal: {
        headers: {
          background: { enabled: !0, fill: "#eceff1", stroke: "#bdc8ce" }
        },
      ...
      hovered: {
        headers: {
          fontColor: "#757575",
          background: { fill: "#bdc8ce", stroke: "#bdc8ce" }
        }
      },
    ...
    stock: {
      padding: [20, 30, 20, 60],
      defaultPlotSettings: {
        xAxis: { background: { fill: "#e8ecf1 0.6", stroke: "#e8ecf1" } },
        legend: {
          ...
          vAlign: "bottom",
          background: null,
          title: { padding: { bottom: 0 }, hAlign: "left", fontSize: 12 }
        }
      },
      scroller: {
        fill: "none",
  ...
  window.anychart.themes.morning = e;
})();
