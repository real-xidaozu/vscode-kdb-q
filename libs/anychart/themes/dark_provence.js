...
(function() {
  ...
  var e = {
    ...
    defaultAxis: {
      stroke: "#5f5b61 0.8",
      title: { fontSize: 15 },
      ticks: { stroke: "#5f5b61 0.8" },
      minorTicks: { stroke: "#534f54 0.8" }
    },
    defaultGridSettings: { stroke: "#5f5b61 0.8" },
    defaultMinorGridSettings: { stroke: "#534f54 0.8" },
    defaultSeparator: { fill: "#5f5b61" },
    defaultTooltip: {
      title: { fontColor: "#745c65", padding: { bottom: 5 }, fontSize: 15 },
      separator: { enabled: !1 },
      fontColor: "#997f89",
      fontSize: 13,
      background: { fill: "#ffffff 0.9", stroke: "#b2aab5", corners: 0 },
      offsetX: 15,
      offsetY: 0,
    ...
    defaultColorRange: {
      stroke: "#8e8691",
      ticks: { stroke: "#8e8691", position: "outside", length: 7, enabled: !0 },
      minorTicks: {
        stroke: "#8e8691",
        position: "outside",
        length: 5,
    ...
    defaultScroller: {
      ...
      thumbs: {
        fill: "#b2aab5",
        stroke: "#616161",
        hovered: { fill: "#cec6d1", stroke: "#757575" }
      }
    },
    ...
    chart: {
      defaultSeriesSettings: {
        ...
        ohlc: {
          normal: { risingStroke: "#aa8ab3", fallingStroke: "#b7cbe2" },
          hovered: { risingStroke: b, fallingStroke: b },
          selected: { risingStroke: "3 #aa8ab3", fallingStroke: "3 #b7cbe2" }
        }
      },
      title: { fontSize: 17 },
    ...
    map: {
      ...
      defaultSeriesSettings: {
        base: {
          normal: { stroke: "#b2aab5", labels: { fontColor: "#212121" } },
          hovered: { fill: "#b0bec5" },
          selected: { stroke: "1.5 #fafafa" }
        },
        connector: {
          normal: { stroke: a, markers: { stroke: "1.5 #616161" } },
          hovered: { markers: { stroke: "1.5 #616161" } },
          selected: {
            stroke: "1.5 #000",
            markers: { fill: "#000", stroke: "1.5 #616161" }
          }
        },
        bubble: { normal: { stroke: c } },
        marker: { normal: { labels: { fontColor: "#b2aab5" } } }
      }
    },
    sparkline: {
      padding: 0,
      ...
      defaultSeriesSettings: {
        area: { stroke: "1.5 #aa8ab3", fill: "#aa8ab3 0.5" },
        column: { fill: "#aa8ab3", negativeFill: "#b7cbe2" },
        line: { stroke: "1.5 #aa8ab3" },
        winLoss: { fill: "#aa8ab3", negativeFill: "#b7cbe2" }
      }
    },
    bullet: {
      background: { stroke: "#464646" },
      defaultMarkerSettings: { fill: "#aa8ab3", stroke: "2 #aa8ab3" },
    ...
    heatMap: {
      normal: { stroke: "1 #464646", labels: { fontColor: "#212121" } },
      hovered: { stroke: "1.5 #464646" },
      selected: { stroke: "2 #fafafa" }
    },
    treeMap: {
      normal: {
        headers: {
          background: { enabled: !0, fill: "#616161", stroke: "#414141" }
        },
      ...
      hovered: {
        headers: {
          fontColor: "#b2aab5",
          background: { fill: "#414141", stroke: "#414141" }
        }
      },
    ...
    stock: {
      padding: [20, 30, 20, 60],
      defaultPlotSettings: {
        xAxis: { background: { fill: "#616161 0.3", stroke: "#5f5b61 0.8" } }
      },
      scroller: {
        fill: "none",
  ...
  window.anychart.themes.darkProvence = e;
})();
