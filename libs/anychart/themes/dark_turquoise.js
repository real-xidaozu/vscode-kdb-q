...
(function() {
  ...
  var e = {
    ...
    defaultAxis: {
      ...
      labels: { enabled: !0 },
      ticks: { stroke: "#929292" },
      minorTicks: { stroke: "#757575" }
    },
    defaultGridSettings: { stroke: "#929292 0.8" },
    defaultMinorGridSettings: { stroke: "#757575 0.6" },
    defaultSeparator: { fill: "#757575" },
    defaultTooltip: {
    ...
    defaultColorRange: {
      stroke: "#757575",
      ticks: { stroke: "#757575", position: "outside", length: 7, enabled: !0 },
      minorTicks: {
        stroke: "#757575",
        position: "outside",
        length: 5,
    ...
    map: {
      ...
      defaultSeriesSettings: {
        base: {
          normal: { stroke: c, labels: { fontColor: "#424242" } },
          selected: { stroke: "1.5 #fafafa" }
        },
        connector: {
          normal: { markers: { stroke: "1.5 #616161" } },
        ...
        bubble: { normal: { stroke: c }, hovered: { stroke: "1.5 #909090" } },
        marker: {
          normal: { labels: { fontColor: "#e0e0e0" }, stroke: "1.5 #424242" },
    ...
    heatMap: {
      normal: { stroke: "1 #424242", labels: { fontColor: "#212121" } },
      hovered: { stroke: "1.5 #424242" },
    ...
    stock: {
      padding: [20, 30, 20, 60],
      defaultPlotSettings: {
        xAxis: { background: { fill: "#616161 0.3", stroke: "#616161" } }
      },
      scroller: {
        fill: "none",
